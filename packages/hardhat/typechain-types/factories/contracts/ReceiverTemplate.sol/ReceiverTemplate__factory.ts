...
import type {
  ReceiverTemplate,
  ReceiverTemplateInterface,
} from "../../../contracts/ReceiverTemplate.sol/ReceiverTemplate";
...
export class ReceiverTemplate__factory {
  static readonly abi = _abi;
  static createInterface(): ReceiverTemplateInterface {
    return new Interface(_abi) as ReceiverTemplateInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): ReceiverTemplate {
    return new Contract(address, _abi, runner) as unknown as ReceiverTemplate;
  }
}

...
const NumberDisplay = ({ value }: { value: bigint }) => {
  ...
  return (
    <div className="flex items-baseline">
      ...
      <span className="font-sans ml-2 inline-flex items-center" title={isEther ? "Multiply by 1e18" : "Divide by 1e18"}>
        <Button variant="ghost" size="icon-xs" type="button" className="h-7 w-7" onClick={() => setIsEther(!isEther)}>

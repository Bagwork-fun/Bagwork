    ...
    <div className="py-5 space-y-3 first:pt-0 last:pb-1">
      <div className={`flex gap-3 ${zeroInputs ? "flex-row justify-between items-center" : "flex-col"}`}>
        ...
        <div className="flex justify-between gap-2">
          ...
          <div className={`flex shrink-0`} title={writeDisabled ? "Wallet not connected or in the wrong network" : undefined}>
            <Button variant="secondary" size="sm" disabled={writeDisabled || isPending} onClick={handleWrite} type="button" className="gap-2 shrink-0">
